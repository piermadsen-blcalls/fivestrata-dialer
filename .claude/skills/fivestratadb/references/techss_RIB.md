...
RV Inventory Batch — mostly views over revived-inventory batch state and timing.

**52 tables** — dimension: 41, view: 11
...
## `RVInventoryAllBatch`  ·  dimension · ~0 rows · InnoDB
PK: `ID`
...
## `RVInventoryAllCallable`  ·  dimension · ~0 rows · InnoDB
PK: `ID`
...
| `callWI` | tinyint | Y | MUL |
| `callBR` | tinyint | Y | MUL |
| `callRF` | tinyint | Y | MUL |
| `callCR` | tinyint | Y | MUL |
| `callHS` | tinyint | Y | MUL |
| `f1` | tinyint | N |  |
| `f2` | tinyint | N |  |
| `f3` | tinyint | N |  |
...
## `RVInventoryAllHW`  ·  dimension · ~0 rows · InnoDB
PK: `RU`, `year`, `month`, `state`, `zip`, `VT`, `TD`, `KB`, `callable`, `f1`, `f2`, `f3`, `lastRevived`
...
## `RVInventoryAllWI`  ·  dimension · ~0 rows · InnoDB
PK: `RU`, `year`, `month`, `state`, `zip`, `VT`, `TD`, `KB`, `callable`, `f1`, `f2`, `f3`, `lastRevived`
...
## `RVInvtyVertical`  ·  dimension · ~4 rows · InnoDB
PK: `VT`
