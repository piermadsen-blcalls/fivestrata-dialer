...
Status: draft (Pier's version). Built straight from `PRD.md`.
...
hours, allowed area, buyer approval; see PRD Section 5), and the call runs on either
...
- Backend (PRD Section 7): the operational brain (the waiting line, the safety
...
- Feature list (PRD Section 6): lead intake, the Campaign builder and calling rules,
