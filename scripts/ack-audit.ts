...
const ACK_TEXT: Record<string, { cat: string; text: string }> = {
  ...
  ack_request_1: { cat: 'request', text: 'Oh — sure thing.' },
  ack_request_2: { cat: 'request', text: 'Yeah, no worries at all.' },
  ack_glad_1: { cat: 'glad', text: 'Glad to hear it!' },
  ack_glad_2: { cat: 'glad', text: "That's great — happy to hear it." },
